...
class DesiGroupsTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("DesiGroupCell", forIndexPath: indexPath) as! UITableViewCell

        // Configure the cell...
        let group = myGroups[indexPath.row] as DesiGroup
            cell.textLabel?.text = group.groupName
            cell.detailTextLabel?.text = group.theDesi.userName + " is the Desi"
